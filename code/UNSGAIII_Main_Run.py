...
def Problem_run(nPop, nFeval, DesVar, seed_no):
    # ref_dirs = get_reference_directions("das-dennis", 2, n_partitions=nPop)
    ref_dirs = get_reference_directions("energy", 2, n_points=nPop)
...
for seed_no in range(1):    
    ...
    Solution = Problem_run(nPop, nFeval, DesVar, seed_vect[seed_no])
    Pareto_Sol = Solution[0]
    Gen_Sol = Solution[1]
    # if DesVar==1:
    #     Pareto_Sol.to_csv("./Results//Pareto_UNSGAIII_noBAT_seedno_{}.csv".format(seed_no))
    #     Gen_Sol.to_csv("./Results//AllPop_UNSGAIII_noBAT_seedno_{}.csv".format(seed_no))
    # else:
    #     Pareto_Sol.to_csv("./Results_BAT//Pareto_UNSGAIII_BAT_seedno_{}.csv".format(seed_no))
    #     Gen_Sol.to_csv("./Results_BAT//AllPop_UNSGAIII_BAT_seedno_{}.csv".format(seed_no))
