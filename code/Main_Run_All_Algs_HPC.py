...
parser.add_argument("--AlgFlag", required=True, type=int,help="Algorithm flag: a number between 1 and 6")
parser.add_argument("--seed_no", required=True, type=int,help="Seed No. between 0 and 30")
parser.add_argument("--nPop", required=True, type=int)
parser.add_argument("--nFeval", required=True, type=int)
parser.add_argument("--DERFlag", required=True, type=int,help="DER combination flag-- 1: DG+RES and 2: DG+RES+Li")

args = parser.parse_args()
    
Alg_Flag = args.AlgFlag
...
# DesVar = 1
# seed_no = 0
# Alg_Flag =  6    # NSGAII: 1, AGE-MOEA: 2, SMS-EMOA: 3, AGE-MOEA2: 4, NSGA-III: 5, UNSGAIII: 6, C-TAEA: 7
