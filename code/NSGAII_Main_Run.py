...
for seed_no in range(1):    
    ...
    Gen_Sol = Solution[1]
    # if DesVar==1:
    #     Pareto_Sol.to_csv("./Results//Pareto_noBAT_seedno_{}.csv".format(seed_no))
    #     Gen_Sol.to_csv("./Results//AllPop_noBAT_seedno_{}.csv".format(seed_no))
    # else:
    #     Pareto_Sol.to_csv("./Results_BAT//Pareto_BAT_seedno_{}.csv".format(seed_no))
    #     Gen_Sol.to_csv("./Results_BAT//AllPop_BAT_seedno_{}.csv".format(seed_no))


# for seed_no in range(2):
#     Solution = NSGAII_run(10, 20, 1, seed_no)
#     Pareto_Sol = Solution[0]
#     Gen_Sol = Solution[1]
#     Pareto_Sol.to_csv("Pareto_{}.csv".format(seed_no))
#     Gen_Sol.to_csv("Allpop_{}.csv".format(seed_no))
